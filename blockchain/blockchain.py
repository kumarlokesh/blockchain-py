...
class Blockchain:
    ...
    def register_node(self, node_url):
        ...
        """
        self.nodes.add(Blockchain.parse_node_url(node_url))
    ...
    def submit_transaction(self, sender_address, recipient_address, value,
        ...
        #Manages transactions from wallet to another wallet
            ...
            transaction_verified = self.verify_transaction_signature(
    ...
    def valid_chain(self, chain):
        ...
        while current_index < len(chain):
            ...
            # Need to make sure that the dictionary is ordered. 
            # Otherwise we'll get a different hash
            transaction_elements = ['sender_address', 'recipient_address',
                                    'value']
            transactions = [OrderedDict((k, transaction[k])
